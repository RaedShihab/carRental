 ...
 class Nav3 extends React.Component {
	...
	<div class="row">
      ...
      <button type="button"  class="btn btn-primary"  >
         ...
         className='nav-link' style={{color: 'white'}} exact>Add car</NavLink> <br></br>
         </button>
         ...
         className='nav-link' style={{color: 'white'}} exact>Update</NavLink> <br></br>
         </button> 
         ...
         className='nav-link' style={{color: 'white'}} exact>delete</NavLink> <br></br>
         </button>
      </div>
        ...
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              ...
              <span></span>
              <input type="reset" className='btn btn-g btn-primary btn-block' />
            </div>
          </div>
        </form>
      </div>
